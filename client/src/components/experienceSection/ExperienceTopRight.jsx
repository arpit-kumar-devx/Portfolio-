const ExperienceTopRight = () => {
  ...
  <p className="text-lg text-center text-lightGrey">
    I'm a <span className="font-bold text-white">Full Stack Developer Intern</span>{" "}
    with hands-on experience in{" "}
    <span className="font-bold text-white">
      MERN stack and Java Spring Boot
    </span>
    , focusing on building secure, scalable, and high-performance web
    applications.
    <br />
